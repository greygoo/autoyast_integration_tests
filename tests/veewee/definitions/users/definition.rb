Veewee::Session.declare({
  ...
  :disk_format => 'VDI',
  :hostiocache => 'off',
  :iso_file => 'SLE-12-Server-DVD-x86_64-Build0872-Media1.iso',
  :iso_src  => 'http://download.suse.de/install/SLE-12-UNTESTED/SLE-12-Server-DVD-x86_64-Build0872-Media1.iso',
  ...
  :shutdown_cmd => 'halt',
  :postinstall_files   => ["postinstall.sh", "test_users.sh"],
